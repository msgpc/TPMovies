...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        ...
        btn.append([InlineKeyboardButton(f"InlineKeyboardButton("NEXT⏩", callback_data=f"next_{req}_{key}_{n_offset}"), InlineKeyboardButton(f"📃 PAGE {round(int(offset)/10)+1} / {round(total/10)}", callback_data="pages")])
    else:
        btn.append(
            [
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Updates', url='https://t.me/PrimeMovieszHD')
        ], [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Updates Channel', url='https://t.me/PrimeMovieszHD')
        ], [
            InlineKeyboardButton('Stats', callback_data='help'),
